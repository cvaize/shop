<svg @class($class ?? null) @style($style ?? null) width="16px" height="16px" aria-hidden="true" focusable="false" role="img" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
